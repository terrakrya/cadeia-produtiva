              ...
              <div v-else class="mt-4">
                ...
                <ul class="text-left">
                  <li v-if="isIOS" class="mb-2">
                    ...
                    centro na parte de baixo da tela
                    <span class="text-white">
                      <font-awesome-icon
                        icon="fa-solid fa-arrow-up-from-bracket"
                      />
                    </span>
                    e, em seguida, selecione "Adicionar à Tela de Início".
                  </li>
                  <li v-if="isAndroid" class="mb-2">
                    ...
                    e selecione "Adicionar à tela inicial" ou "Instalar
                    aplicativo"
                  </li>
                  <li v-if="!isIOS && !isAndroid" class="mb-2">
                    ...
                    na barra de endereço ou no menu do navegador e selecione
